...
assign arp_tx_packetizer_sink_param_sender_ip = 28'd167772390;
always @(*) begin
...
assign ip_tx_packetizer_sink_param_sender_ip = 28'd167772390;
...
always @(posedge sys_clk) begin
	...
	arp_rx_valid <= (((((arp_rx_depacketizer_source_valid & (arp_rx_depacketizer_source_param_hwtype == 1'd1)) & (arp_rx_depacketizer_source_param_proto == 12'd2048)) & (arp_rx_depacketizer_source_param_hwsize == 3'd6)) & (arp_rx_depacketizer_source_param_protosize == 3'd4)) & (arp_rx_depacketizer_source_param_target_ip == 28'd167772390));
	...
	ip_rx_valid <= ((((ip_rx_depacketizer_source_valid & (ip_rx_depacketizer_source_param_target_ip == 28'd167772390)) & (ip_rx_depacketizer_source_param_version == 3'd4)) & (ip_rx_depacketizer_source_param_ihl == 3'd5)) & (ip_rx_liteethipv4checksum_value == 1'd0));
